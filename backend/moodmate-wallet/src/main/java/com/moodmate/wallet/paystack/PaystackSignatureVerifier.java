 ...
 * the raw request body, keyed with the Paystack secret key, hex-encoded. Must run against the
 * exact raw bytes Paystack sent - never against a re-serialized version of a parsed object.
 */
@Component
