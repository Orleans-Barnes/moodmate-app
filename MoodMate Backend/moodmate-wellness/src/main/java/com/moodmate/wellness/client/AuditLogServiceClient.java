...
/** Admin narrow-gaps pass - direct (non-gateway) service-to-service call to admin-service's
 * audit-log fan-in, mirroring moodmate-support/moodmate-community/moodmate-auth's
 * AuditLogServiceClient exactly (see moodmate-admin's InternalAuditLogController doc comment).
 * Fire-and-forget: a logging failure must never fail the real admin action (article/event
 * create/update/delete) that already succeeded. */
@Slf4j
@Component
