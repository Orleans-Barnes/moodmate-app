...
public class User {
    ...
    // Institution Management (Milestone 2, Step 1) - see V13 migration's doc comment. Plain
    // nullable id, no JPA @ManyToOne: Institution lives in the admin schema, a different
    // service's schema on the same physical database, and this project never puts real FK
    // constraints across service boundaries. `institution` (the free-text field above) stays the
    // display value; this is purely the link used by future licensing/analytics work.
