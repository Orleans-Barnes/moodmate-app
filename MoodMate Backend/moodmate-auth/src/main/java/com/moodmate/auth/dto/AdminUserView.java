...
public record AdminUserView(Long id, String email, String fullName, String institution, Long institutionId,
                             Role role, boolean guest, boolean banned, String bannedReason, Instant bannedAt,
