...
import { JournalVoiceScreen } from '@/screens/journal/JournalVoiceScreen';
import { JournalViewScreen } from '@/screens/journal/JournalViewScreen';
import { MentalHealthArticleScreen } from '@/screens/journal/MentalHealthArticleScreen';
import { MentalHealthQuestionnaireIntroScreen } from '@/screens/journal/MentalHealthQuestionnaireIntroScreen';
import { MentalHealthQuestionnaireScreen } from '@/screens/journal/MentalHealthQuestionnaireScreen';
import { CaringMentalHealthArticleScreen } from '@/screens/journal/CaringMentalHealthArticleScreen';
import { CommonConcernsArticleScreen } from '@/screens/journal/CommonConcernsArticleScreen';
import { LearningMentalHealthArticleScreen } from '@/screens/journal/LearningMentalHealthArticleScreen';
import { EmotionMoodArticleScreen } from '@/screens/journal/EmotionMoodArticleScreen';
...
import { CounsellorDetailScreen } from '@/screens/support/CounsellorDetailScreen';
...
import { EscalateCaseScreen } from '@/screens/collaboration/EscalateCaseScreen';
...
import { StoryPacksScreen } from '@/screens/stories/StoryPacksScreen';
...
export function RootNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="EscalateCase" component={EscalateCaseScreen} />
      ...
      <Stack.Screen name="StoryPacks" component={StoryPacksScreen} />
      ...
      <Stack.Group screenOptions={{ presentation: 'modal' }}>
        ...
        <Stack.Screen name="JournalVoice" component={JournalVoiceScreen} />
        <Stack.Screen name="JournalView" component={JournalViewScreen} />
        <Stack.Screen name="MentalHealthArticle" component={MentalHealthArticleScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="MentalHealthQuestionnaireIntro" component={MentalHealthQuestionnaireIntroScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="MentalHealthQuestionnaire" component={MentalHealthQuestionnaireScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="CaringMentalHealthArticle" component={CaringMentalHealthArticleScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="CommonConcernsArticle" component={CommonConcernsArticleScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="LearningMentalHealthArticle" component={LearningMentalHealthArticleScreen} options={{ animation: 'slide_from_bottom' }} />
        <Stack.Screen name="EmotionMoodArticle" component={EmotionMoodArticleScreen} options={{ animation: 'slide_from_bottom' }} />
