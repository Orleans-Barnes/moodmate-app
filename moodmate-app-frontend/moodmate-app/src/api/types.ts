...
export interface BookedSlotView {
  scheduledAt: string;
  windowEndsAt: string;
}
...
export type NotificationTypeKey =
  ...
  // Counsellor/peer-mentor application + standing changes (admin approves/rejects/suspends/
  // reinstates) - see backend NotificationType's doc comment for why these are distinct from
  // MENTOR_ACCEPTED/MENTOR_DECLINED above.
  | 'COUNSELLOR_APPROVED' | 'COUNSELLOR_REJECTED' | 'COUNSELLOR_SUSPENDED' | 'COUNSELLOR_REINSTATED'
  | 'MENTOR_APPROVED' | 'MENTOR_REJECTED' | 'MENTOR_DEACTIVATED' | 'MENTOR_REACTIVATED'
