...
export interface BadgeDef {
  id: BadgeId;
  name: string;
  ionIcon: keyof typeof import('@expo/vector-icons').Ionicons.glyphMap;
  desc: string;
}

export const BADGE_DEFS: BadgeDef[] = [
  { id: 'first_checkin',    name: 'First Step',       ionIcon: 'leaf-outline',         desc: 'Complete your first mood check-in' },
  { id: 'streak_3',         name: '3-Day Streak',     ionIcon: 'flame-outline',        desc: 'Check in 3 days in a row' },
  { id: 'streak_7',         name: 'Week Warrior',     ionIcon: 'flash-outline',        desc: 'Maintain a 7-day streak' },
  { id: 'streak_30',        name: 'Monthly Legend',   ionIcon: 'trophy-outline',       desc: '30-day streak — unstoppable!' },
  { id: 'journaller',       name: 'Journaller',       ionIcon: 'book-outline',         desc: 'Write 3 journal entries' },
  { id: 'deep_breather',    name: 'Deep Breather',    ionIcon: 'water-outline',        desc: 'Complete 3 breathing sessions' },
  { id: 'community_voice',  name: 'Community Voice',  ionIcon: 'chatbubbles-outline',  desc: 'Post something in the community' },
  { id: 'grateful_heart',   name: 'Grateful Heart',   ionIcon: 'heart-outline',        desc: 'Add 3 gratitude notes' },
  { id: 'xp_100',           name: 'Rising Star',      ionIcon: 'star-outline',         desc: 'Earn 100 XP' },
  { id: 'xp_500',           name: 'Wellness Pro',     ionIcon: 'diamond-outline',      desc: 'Earn 500 XP' },
];
...
const MISSION_POOL: DailyMission[] = [
  { ionIcon: 'book-outline',        title: 'Write one thing on your mind',          xp: 20, route: 'JournalEntry', params: { template: 'Free write', emoji: 'journal' } },
  { ionIcon: 'water-outline',       title: 'Complete a 4-min breathing reset',      xp: 20, route: 'BreathingSession', params: { session: 'Breathing Reset', duration: 240 } },
  { ionIcon: 'heart-outline',       title: "Add one thing you're grateful for",      xp: 15, route: 'GratitudeJar' },
  { ionIcon: 'hand-left-outline',   title: 'Try the 5-4-3-2-1 grounding exercise',  xp: 20, route: 'Grounding' },
  { ionIcon: 'checkmark-circle-outline', title: 'Check in with how you feel today', xp: 10, route: 'CheckIn' },
  { ionIcon: 'ellipse-outline',     title: 'Pop some stress away',                   xp: 10, route: 'BubblePop' },
  { ionIcon: 'chatbubbles-outline', title: 'Share a thought in the community',       xp: 15, route: 'Community' },
];
