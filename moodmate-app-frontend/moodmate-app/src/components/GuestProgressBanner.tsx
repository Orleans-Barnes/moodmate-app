...
const LOCKED_FEATURES = [
  { icon: 'flame-outline' as const, label: 'Daily streaks' },
  { icon: 'star-outline' as const, label: 'XP & levels' },
  { icon: 'ribbon-outline' as const, label: 'Badges' },
  { icon: 'trending-up-outline' as const, label: 'Mood history' },
];
        ...
        <View style={s.chips}>
          {LOCKED_FEATURES.map((f) => (
            <View key={f.label} style={s.chip}>
              <Ionicons name={f.icon} size={12} color="rgba(255,255,255,0.75)" />
