...
import { Animated, View, RefreshControl, StyleSheet, ViewStyle, StyleProp } from 'react-native';
...
export function Screen({
  ...
  const resolvedBackground = isDark ? darkPalette.bg : backgroundColor;

  return (
    <View style={[styles.flex, { backgroundColor: resolvedBackground }]}>
      <Animated.ScrollView
        style={styles.flex}
        onScroll={onScroll}
