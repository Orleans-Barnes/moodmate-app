 ...
 * the local offline catalogue first, then the live backend catalogue when available. Renders each
 * institution logo when the catalogue provides one, with a calm initials badge fallback for offline
 * devices or schools whose remote logo cannot be fetched.
 */
