    ...
    <View style={s.root}>
      ...
      >
        ...
        <View style={s.card}>
          ...
          <View style={[s.settingRow, s.settingBorder]}>
            ...
            <Switch
              ...
              trackColor={{ false: colors.line, true: colors.coralDeep }}
              thumbColor='#FFFFFF'
            />
          </View>
        </View>
        ...
        <View style={s.statsCard}>
          <LinearGradient colors={['#468752', '#579E65']} style={s.statsGrad} start={{x:0,y:0}} end={{x:1,y:1}}>
...
const s = StyleSheet.create({
  ...
  onlineDot: {
    ...
    borderWidth: 2, borderColor: colors.coralDeep,
  },
  ...
  card: { backgroundColor: colors.surface, borderRadius: 18, padding: spacing.lg, ...shadow.sm, gap: spacing.sm },
  cardTitle: { fontFamily: fonts.bodyBold, fontSize: fontSizes.md, color: colors.ink },

  tags: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  tag: {
    backgroundColor: '#E9F2EC', borderRadius: radii.pill,
    paddingHorizontal: 12, paddingVertical: 5,
  },
  tagTxt: { fontFamily: fonts.bodyBold, fontSize: fontSizes.xs, color: colors.coralDeep },

  bioText: { fontFamily: fonts.bodyMedium, fontSize: fontSizes.sm, color: colors.inkSoft, lineHeight: 22 },

  hourRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#E9F2EC' },
  dayTxt: { fontFamily: fonts.bodyBold, fontSize: fontSizes.sm, color: colors.ink },
  timeTxt: { fontFamily: fonts.bodyMedium, fontSize: fontSizes.sm, color: colors.coralDeep },
  ...
  settingBorder: { borderTopWidth: 1, borderTopColor: '#E9F2EC', marginTop: 8, paddingTop: 12 },
  ...
  logoutTxt: { fontFamily: fonts.bodyBold, fontSize: fontSizes.base, color: colors.error },
