...
const s = StyleSheet.create({
  ...
  input: {
    ...
    backgroundColor: colors.surfaceContainer, borderRadius: radii.sm, paddingHorizontal: spacing.md, paddingVertical: spacing.sm,
  },
  inputFlex: { flex: 1 },
  typeRow: { flexDirection: 'row', gap: 6, flexWrap: 'wrap' },
  typeChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: radii.pill, backgroundColor: colors.surfaceContainer },
  typeChipActive: { backgroundColor: colors.coral },
  ...
  statusPillInactive: { backgroundColor: colors.surfaceContainer },
