...
const s = StyleSheet.create({
  ...
  filterChipActive: { backgroundColor: colors.coral },
  ...
  typeBadge: { backgroundColor: colors.coralSoft, borderRadius: radii.pill, paddingHorizontal: spacing.sm, paddingVertical: 2 },
  typeBadgeText: { fontFamily: fonts.bodyBold, fontSize: 9, color: colors.coralDeep, letterSpacing: 0.5 },
  ...
  previewBox: { backgroundColor: '#EEF3EF', borderRadius: radii.sm, padding: spacing.sm, marginBottom: spacing.md },
