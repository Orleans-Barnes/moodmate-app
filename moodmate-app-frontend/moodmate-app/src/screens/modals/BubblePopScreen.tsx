...
import { BUBBLE_ICONS, type IonName } from '@/theme/iconMap';
    ...
    return (
      <View style={[styles.container, { paddingBottom: insets.bottom + spacing.lg }]}>
        ...
        <View style={styles.celebCenter}>
          <Ionicons name="lock-closed" size={44} color={colors.inkFaint} />
          ...
          <View style={styles.btnsRow}>
            <Button label="Upgrade to Pro" variant="primary" onPress={() => openProUpgrade(navigation, 'bubble-pop')} />
          </View>
        </View>
      </View>
    );
  ...
  if (gameOver) {
    return (
      <View style={[styles.container, { paddingBottom: insets.bottom + spacing.lg }]}>
        ...
        <View style={styles.celebCenter}>
          <Ionicons name="water" size={44} color={calm.primary} />
        ...
        {bubbles.map((b) => (
          ...
          >
            <Pressable
              ...
              >
              <Ionicons name={b.icon} size={28} color={calm.primary} />
              </Pressable>
          </Animated.View>
        ))}
      </View>
