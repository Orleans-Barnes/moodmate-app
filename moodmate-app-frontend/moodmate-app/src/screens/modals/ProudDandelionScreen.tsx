        ...
        >
          ...
          <View style={s.headerContent}>
            <View style={s.dandelionWrap}>
              <Animated.View style={{ transform: [{ scale: dandelionScale }] }}>
        ...
        >
          ...
          <View style={s.inputCard}>
            ...
            <Animated.View style={{ transform: [{ scale: btnScale }] }}>
              ...
              >
                <LinearGradient
                  colors={canSubmit ? ['#468752', '#579E65'] : [colors.outline, colors.inkFaint]}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
                  style={s.submitGrad}
                >
          ...
          {moments.length === 0 && (
            <View style={s.emptyWrap}>
              <Ionicons name="leaf-outline" size={44} color={colors.inkFaint} />
