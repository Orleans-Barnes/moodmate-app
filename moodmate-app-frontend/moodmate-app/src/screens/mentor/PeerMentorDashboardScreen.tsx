  ...
  return (
    <View style={s.root}>
      ...
      >
        ...
        <Pressable style={s.collaborationButton} onPress={() => navigation.navigate('EscalateCase')}>
          <Ionicons name="shield-outline" size={19} color="#FFFFFF" />
          <View style={{ flex: 1 }}><Text style={s.collaborationTitle}>Request counsellor assistance</Text><Text style={s.collaborationSub}>Escalate a difficult case safely</Text></View>
        ...
        {loading ? (
          ...
          <View style={s.emptyBox}>
            <Ionicons name="mail-open-outline" size={36} color={colors.inkFaint} />
...
const s = StyleSheet.create({
  ...
  collaborationButton: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: colors.sageDeep, borderRadius: radii.md, padding: spacing.md, marginBottom: spacing.sm },
  collaborationTitle: { fontFamily: fonts.bodyBold, fontSize: fontSizes.sm, color: '#FFFFFF' },
  collaborationSub: { fontFamily: fonts.body, fontSize: 10, color: 'rgba(255,255,255,0.75)', marginTop: 2 },
  reqCard: {
  ...
  acceptBtn: { flex: 1, paddingVertical: 8, borderRadius: radii.sm, backgroundColor: colors.sageDeep, alignItems: 'center' },
