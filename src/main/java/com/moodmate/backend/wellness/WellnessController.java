...
public class WellnessController {
     ...
     * Returns the updated wellness state (so the client can refresh leaf balance + hasStreakShield).
     */
    @PostMapping("/streak/shield")
    public WellnessStateResponse buyStreakShield() {
        return wellnessService.buyStreakShield(currentUser.id());
    }
}
