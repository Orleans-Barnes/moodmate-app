...
public class WellnessProfile {
    ...
    /** When true, the next streak-break is absorbed instead of resetting the streak to 0. */
    @Column(name = "streak_shield_active", nullable = false)
    @Builder.Default
    private boolean streakShieldActive = false;
