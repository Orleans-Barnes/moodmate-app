 ...
 *
 * Moved from {@code wellness.GoalEngine} to {@code common} so the wallet and payments domains
 * can use it without importing from the wellness package.
 *
...
public final class GoalEngine {
     ...
     * @param toggledGoalWasDoneBefore    its {@code done} flag before this toggle (we're flipping it)
