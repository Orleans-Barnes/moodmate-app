...
/**
 * Nothing else in this app ever transitions a subscription out of TRIALING/ACTIVE on its own -
 * without this sweep, a lapsed trial or an unrenewed paid period would just stay "active" forever
 * even after trialEndsAt/currentPeriodEnd has passed. Runs once a day; @EnableScheduling is on
 * MoodmateBackendApplication.
 */
@Component
