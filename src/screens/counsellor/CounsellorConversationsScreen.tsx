...
const s = StyleSheet.create({
  ...
  avatar: { width: 50, height: 50, borderRadius: 16, backgroundColor: '#2980B9', alignItems: 'center', justifyContent: 'center' },
  avatarUnread: { backgroundColor: '#1B4F72' },
  ...
  badge: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#2980B9', alignItems: 'center', justifyContent: 'center' },
