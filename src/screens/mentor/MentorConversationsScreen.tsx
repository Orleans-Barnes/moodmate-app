...
const s = StyleSheet.create({
  ...
  avatar: { width: 50, height: 50, borderRadius: 16, backgroundColor: '#40916C', alignItems: 'center', justifyContent: 'center' },
  avatarUnread: { backgroundColor: '#2D6A4F' },
  ...
  badge: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#40916C', alignItems: 'center', justifyContent: 'center' },
