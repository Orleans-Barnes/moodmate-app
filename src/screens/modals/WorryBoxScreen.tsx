      ...
      <View style={s.root}>
        ...
        >
          ...
          <View style={s.inputCard}>
            ...
            >
              <LinearGradient
                colors={canLock ? ['#1A5C56', '#2A7A72'] : ['#C8C8C8', '#DEDEDE']}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
                style={s.lockBtnGrad}
              >
