    ...
    <View style={s.root}>
      ...
      >
        {isGuest ? (
          ...
          <ActivityIndicator size="large" color="#2D6A9F" style={{ marginTop: 60 }} />
        ) : logs.length === 0 ? (
          <View style={s.emptyWrap}>
            <Ionicons name="moon" size={44} color="#818CF8" />
          ...
          >
            ...
            <View style={s.timeRow}>
              <View style={s.timeField}>
                <View style={{flexDirection:'row',alignItems:'center',gap:5}}><Ionicons name="moon" size={13} color="#818CF8" /><Text style={s.fieldLbl}>Bedtime</Text></View>
                <TextInput
                  style={s.timeInput}
                  value={bedtime}
...
const s = StyleSheet.create({
  ...
  statVal:     { fontFamily: fonts.display, fontSize: fontSizes.lg, color: '#1E3A5F' },
  ...
  ctaBtn:     { backgroundColor: '#2D6A9F', paddingHorizontal: spacing.xxl, paddingVertical: 14, borderRadius: radii.pill },
  ctaBtnTxt:  { fontFamily: fonts.bodyBold, fontSize: fontSizes.base, color: '#fff' },

  logCard:    { flexDirection: 'row', backgroundColor: colors.surface, borderRadius: 16, marginBottom: spacing.sm, overflow: 'hidden', ...shadow.sm },
  qualityBar: { width: 5 },
  ...
  durationPreview: { fontFamily: fonts.bodyMedium, fontSize: fontSizes.sm, color: '#2D6A9F', marginBottom: spacing.md },
  ...
  saveBtn:    { flex: 1, paddingVertical: 14, alignItems: 'center', borderRadius: radii.pill, backgroundColor: '#1E3A5F' },
