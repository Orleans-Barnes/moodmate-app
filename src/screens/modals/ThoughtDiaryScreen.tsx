          ...
          {step === 4 && (
            <>
              ...
              {newIntensity < intensity && (
                <View style={[s.infoBox, { backgroundColor: '#E8F5EE', marginTop: spacing.lg }]}>
                  <Text style={[s.infoText, { color: '#1F6B42' }]}>
...
const s = StyleSheet.create({
  ...
  infoBox: {
    backgroundColor: '#F0F4FF', borderRadius: radii.sm,
    padding: spacing.md, marginBottom: spacing.lg,
  },
  infoText: { fontFamily: fonts.bodyMedium, fontSize: fontSizes.sm, color: '#3A4A6B', lineHeight: 20 },
